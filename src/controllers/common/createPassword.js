...
module.exports = wrapAsync(async (req, res, next) => {
  ...
  const secret = crypto.createHmac('sha512', process.env.HMAC_1024BIT_SECRET_KEY).update(`${process.env.JWT_512BIT_SECRET_KEY}${userRecord.createdAt.getTime()}`).digest()
